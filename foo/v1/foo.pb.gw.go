...
/*
Package foo is a reverse proxy.
...
func RegisterFooServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FooServiceServer) error {
	...
	mux.Handle("POST", pattern_FooService_GetFoo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/foo.v1.FooService/GetFoo", runtime.WithHTTPPathPattern("/foo.v1.FooService/GetFoo"))
		if err != nil {
...
func RegisterFooServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FooServiceClient) error {
	...
	mux.Handle("POST", pattern_FooService_GetFoo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/foo.v1.FooService/GetFoo", runtime.WithHTTPPathPattern("/foo.v1.FooService/GetFoo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_FooService_GetFoo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"foo.v1.FooService", "GetFoo"}, ""))
)
